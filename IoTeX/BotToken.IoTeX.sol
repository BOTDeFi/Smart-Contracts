...
contract BotToken is Context, IERC20, Ownable {
    ...
    IMimoV2Router02 public immutable pcsV2Router;
    ...
    constructor () {
        ...
        // Create a MimoProtocol pair for this new token
        IMimoV2Router02 _pcsV2Router = IMimoV2Router02(router);
        pcsV2Pair = IMimoFactory(_pcsV2Router.factory()).createPair(address(this), _pcsV2Router.WETH());
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // also, don't swap & liquify if sender is MimoProtocol pair.
    ...
    function swapTokensForETH(uint256 tokenAmount) private {
        // generate the MimoProtocol pair path of token -> weth
